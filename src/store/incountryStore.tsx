...
export const useInCountryStore = create<TourStore>()(
  persist(
    (set) => ({
      tours: [],
      loading: false,
    ...
    {
      name: "tour-incountry-storage", // 🔹 tên key lưu trong localStorage
